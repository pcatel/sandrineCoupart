...
if ($resultRegimes && $resultRegimes->num_rows > 0) {
    ...
    echo '<p class="fw-medium text-uppercase text-primary mb-2">Recettes de base</p>';
    ...
    while ($rowRegime = $resultRegimes->fetch_assoc()) {
        ...
        echo "<tr>";
        echo "<td><a href='liste_recettes_regime.php?regimeID=$regimeID' class='text-decoration-none link-success'>$regimeNom</a></td>";
